...
public class TwoStarPlayFragment extends BaseFragment{
    ...
    private void initData() {
        ...
        mPlayAdapter01=new StarPlayAdapter(getActivity(),mList2,2);
        mPlayAdapter02=new StarPlayAdapter(getActivity(),mList1,1);
        ...
        if (bundle != null) {
            ...
            if (mCheckList != null) {
                mPlayAdapter01.setCheckedList(mCheckList.get(2));
                mPlayAdapter02.setCheckedList(mCheckList.get(1));
                setData();
            }else {
    ...
    private void initListen() {
        ...
        RxBus.getDefault().doSubscribeMain(getActivity(), RxBusBean.class, new Consumer<RxBusBean>() {
            ...
            public void accept(RxBusBean rxBusBean) throws Exception {
                if(rxBusBean.getType()== RxBusType.Shake_Play && rxBusBean.getIntType()==2){
